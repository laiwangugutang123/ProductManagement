<template>
    <div>
        ...
        <el-dialog v-model="visible" v-if="visible" width="30%" title="">
            <RelationEdit  :id="choiceId" @doCancel="doCancel"></RelationEdit>
        </el-dialog>
    </div>
</template>
<script>
import ListView from '@/components/list-view/list-view.vue';
import { page, del } from "@/http/pms/relationApi/relationApi";
import Msg from "@/utils/msg/msg"
import RelationEdit from '../../../../components/pms/relationEdit.vue';
export default {
    mounted() {
    ...
    methods: {
        ...
        buildColumn() {
            return [
                ...
                { prop: "productAttributeId", label: "商品属性id", width: 200 },
                { prop: "productCategoryId", label: "商品类别id", width: 100 },
            ];
        }
    },
    components: { ListView, RelationEdit }
}
</script>
<style  scoped>
.up {
