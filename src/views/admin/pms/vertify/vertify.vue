<template>
    <div>
        ...
        <el-dialog v-model="visible" v-if="visible" width="30%" title="">
            <VertifyEdit  :id="choiceId" @doCancel="doCancel"></VertifyEdit>
        </el-dialog>
    </div>
</template>
<script>
import ListView from '@/components/list-view/list-view.vue';
import { page, del } from "@/http/pms/vertifyApi/vertifyApi";
import Msg from "@/utils/msg/msg"
import VertifyEdit from '../../../../components/pms/vertifyEdit.vue';
export default {
    mounted() {
    ...
    methods: {
        ...
        buildColumn() {
            return [
                ...
                { prop: "status", label: "情况", width: 100 },
                { prop: "vertifyMan", label: "审核人", width: 100 },
            ];
        }
    },
    components: { ListView, VertifyEdit }
}
</script>
<style  scoped>
.up {
